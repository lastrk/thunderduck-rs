...
tools: [Read, Glob, Grep, mcp__codegraph__*, mcp__semble__*]
model: opus
effort: max
---
...
- Every API change: run `codegraph_explore` on the symbol, cite caller count from the blast radius; prefer it and `semble.search` over Grep.
