...
mod tests {
    ...
    fn parse_expression_stack_multi_alias_lowers_to_wrapper() {
        // `F.expr("stack(2, 'age', CAST(age AS DOUBLE),
        // 'salary', salary) as (metric, value)")` uses the multi-alias path:
