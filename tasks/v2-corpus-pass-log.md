# v2 Corpus Pass Log — consolidated

Merges the two sequential eras of the v2 corpus effort into one log:

- **Part I — Corpus-Driven era** (2026-07-02 → 2026-07-06), formerly
  `v2-corpus-driven-pass-log.md`. Early corpus build-out under the retired
  corpus-driven-iteration methodology.
- **Part II — Goal-driven era** (2026-07-09 →), formerly this file's original
  content. Runs under `/goal`; its Pass 0 baseline doubles as the regression
  oracle (no case green at pass 0 may go red later).

**Pass numbers restart between the two Parts** (both eras have a "Pass 1",
"Pass 20", …). Unqualified `Pxx` references in the deferred ledgers / goal
seeds point at the **Goal-driven era (Part II)** unless stated otherwise.

---

# Part I — Corpus-Driven era (2026-07-02 → 2026-07-06)
...
# Part II — Goal-driven era (2026-07-09 →)
